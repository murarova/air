...
export const mountingRows = [
  createData('Стандартный монтаж, 07-09', "20-25 м2", "3000 грн"),
  createData('Стандартный монтаж, 12', "35 м2", "3200 грн"),
  createData('Стандартный монтаж, 18', "50 м2", "3600 грн"),
  createData('Стандартный монтаж (сплит, кассетного, напольнопотолочного типа), 24 - 30', "от 70 м2", "4500 грн"),
  createData('Стандартный монтаж (сплит, кассетного, напольнопотолочного типа), 36 - 60', "от 100 м2", "6500 грн"),
];
