...
const mountingRows_lg = [
  ...
  createData('Стандартний монтаж (спліт, касетного, напольно-стельового типу)', "24", "от 70 м2", "4 500"),
  createData('Стандартний монтаж (спліт, касетного, напольно-стельового типу)', "36", "от 100 м2", "6 500"),
];
...
const mountingRowsWithoutTrails_lg = [
  ...
  createData('Кондиціонер (спліт, касетного, напольно-стельового типу)', "24", "от 70 м2", "от 2 500"),
  createData('Кондиціонер (спліт, касетного, напольно-стельового типу)', "36", "от 100 м2", "от 3 500"),
];
...
export const maintenanceRows = [
  createData('Чищення внутрішнього блоку, ТО (7, 9, 12 BTU)', null, "1 000"),
  createData('Чищення внутрішнього блоку, ТО', "50 м2 - 100 м2", "1 200"),
  createData('Заправка фреоном R - 410, R- 32', null, "100 гр/ 200"),
  createData('Заправка фреоном R - 22', null, "100 гр/ 250"),
];

export const maintenanceHeader = [ 'Вид робіт', 'Умовна площа приміщення', 'Вартість, грн' ];
...
export const trailRows = [
  ...
  createData('Монтаж фреонової магістралі', "9 и 16 мм", "от 70 м2", "2 500")
];
...
export const trailRowsAdditionalMaterial = [
  createData('Фреономагістраль', "7, 9, 12", "20-35 м2", "6 и 9 мм", "450"),
  createData('Фреономагістраль', "12, 18", "35 м2", "6 и 12 мм", "550"),
  createData('Фреономагістраль', null, "50 - 70 м2", null, "700"),
  createData('Дренажна труба', null,  null, "16 мм", "40"),
  createData('Короб-канал 60х60', null,  null,  null, "250"),
];

export const trailHeaderAdditionalWorks = [ 'Вид робіт', 'Вартість, грн' ]

export const trailHeaderAdditionalMaterial = [ 'Матеріали', 'Продуктивність кондиціонера, BTU', 'Умовна площа приміщення', 'Діаметр трубы', 'Вартість, грн' ]
...
export const dismantlingRows = [
  ...
  createData('Демонтаж касетних, канальних, кондиціонерів 18-24 btu', "1 000"),
