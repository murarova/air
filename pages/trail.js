    ...
    <div className={ classes.wrapper }>
      ...
      <div className={ classNames(classes.main, classes.mainRaised) }>
        <div className={ classes.container }>
          <h2>Закладка трасс.</h2>
          <div className={ classes.sectionText }>
            <h4 className={ classes.trailTitle }>Закладка фреономагистрали осуществляется двумя способами.</h4>
            <h4 className={ classes.trailSubTitle }>К первому варианту относиться закладка на этапе ремонта. </h4>
            ...
            <h4 className={ classes.trailSubTitle }>Второй вариант, это монтаж фреономагистрали по готовому ремонту.</h4>
